...
class Main {
    static function main() {
        var logger = new CapstoneLogger(20240108, "wandquest", "0cf0c7d5653e1b8477b410fa289cc19e", 1);
		var doNothing:Bool->Void = function(b:Bool):Void {
