...
var camera_width = (960*CAMERA_SCALE_NATIVE)
var camera_height= (540*CAMERA_SCALE_NATIVE)
...
view_camera[0] = camera_create_view(0, 0, view_wport[0], view_hport[0], 0, -1, -1, -1, VIEWPORT_WIDTH/2, VIEWPORT_HEIGHT/2);
